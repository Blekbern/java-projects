...
public class JFrameDialogy extends JFrame implements ItemListener {
    ...
    JRadioButton jrInfo = new JRadioButton("Informace", 
            new javax.swing.ImageIcon("src/main/java/ukazkaMoznosti/ikony/metal-info.png"));
    JRadioButton jrWarning = new JRadioButton("Varování",
            new javax.swing.ImageIcon("src/main/java/ukazkaMoznosti/ikony/metal-warning.png"));
    JRadioButton jrQuestion = new JRadioButton("Otázka",
                new javax.swing.ImageIcon("src/main/java/ukazkaMoznosti/ikony/metal-question.png"));
    JRadioButton jrError = new JRadioButton("Chyba", 
            new javax.swing.ImageIcon("src/main/java/ukazkaMoznosti/ikony/metal-error.png"));
