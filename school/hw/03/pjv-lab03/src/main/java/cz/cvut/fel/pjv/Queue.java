...
public interface Queue {
     ...
     * {@link #enqueue(String)} method call returns {@code false} and no element is enqueued.
     *
    ...
    /**
     * Prints all elements in the queue on the stdout. Each element is printed on single line. This method is intended
